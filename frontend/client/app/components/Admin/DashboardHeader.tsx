...
const DashboardHeader: FC<Props> = () => {
  ...
  return (
    <div className="w-full flex items-center justify-end p-6 fixed top-5 right-8">
      ...
      {open && (
        <div className="w-[350px] h-[50vh] dark:bg-[#111C43] bg-white shadow-xl absolute top-16 z-10 rounded p-3">
          <h5 className="text-center text-[28px] font-Poppins text-black dark:text-white">
            Notifications
          </h5>
