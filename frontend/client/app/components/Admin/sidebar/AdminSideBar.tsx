...
const Sidebar = () => {
  const { user } = useSelector((state: any) => state.auth); // Select the user from the Redux state
            ...
            <Box mb="25px">
              <Box display="flex" justifyContent="center" alignItems="center">
                <Image
                  ...
                  width={100}
                  height={100}
                  src={user?.avatar?.url || avatarDefault} // Check if user and user.avatar exist
                  style={{
                    cursor: "pointer",
                    borderRadius: "10%",
              ...
              <Box textAlign="center">
                ...
                >
                  {user?.name || "Guest"}{" "}
                  {/* Handle case where user.name is undefined */}
                </Typography>
                <Typography
                  variant="h6"
                  sx={{ m: "10px 0 0 0" }}
